...
public class DTGeneticMiningMatricesWithHeuristicsTasksArcs implements
	...
	public DTGeneticMiningMatricesWithHeuristicsTasksArcs(Random gen,
	...
	private void setDuplicatesMapping() {
		...
		for (int i = 0; i < outCausalRelations.length; i++) {
			...
			if (numDuplicatesPerTask[i] == 0) {
				numDuplicatesPerTask[i] = 1; // for the start/end tasks, and
				// duplicate
