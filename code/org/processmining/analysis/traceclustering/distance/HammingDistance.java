...
public class HammingDistance extends DistanceMetric {
	 ...
	 * y<numberOfInstances; y++) { double distance = 0.0; double valueX, valueY;
	 * for(Profile profile : profiles) { for(int i=0; i<profile.numberOfItems();
	 * i++) { valueX = profile.getValue(x, i); valueY = profile.getValue(y, i);
	 * if((valueX > 0.0) != (valueY > 0.0)) { distance++; } } }
