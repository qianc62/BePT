 ...
 * E</tt>
 * of edges. Each edge e=(v1,v2) in E connects vertex v1 to vertex v2. for more
 * information about graphs and their related definitions see <a
...
public interface Graph<V, E> {
     ...
     * e2</code>
	 * is found then the newly created edge <code>e</code> is abandoned, the
	 * method leaves this graph unchanged returns <code>
     * null</code>.
	 * </p>
	 * 
	 * @param sourceVertex
	 ...
	 * <code>e2.equals(e)</code>. If this graph already contains such an edge,
	 * the call leaves this graph unchanged and returns <tt>false</tt>. Some
	 * graphs do not allow edge-multiplicity. In such cases, if the graph
     ...
     * u</code>
	 * such that <code>u.equals(v)</code>, the call removes all edges that touch
	 * <code>u</code> and then removes <code>u</code> itself. If no such
