...
public interface GraphPath<V, E> {
	 ...
	 * doing the same successively across subsequent edges;
	 * {@link Graphs#getPathVertexList} provides a convenience method for this.
	 * 
	 * <p>
	 * Whether or not the returned edge list is modifiable depends on the path
	 * implementation.
	 * 
