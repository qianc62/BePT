...
public abstract class Graphs {
	 ...
	 * {@link #addEdgeWithVertices} is used for the transfer, so source vertexes
	 * will be added automatically to the target graph.
	 * 
	 * @param destination
	 ...
	 * 
	 * @param g
	 *            the graph for which an undirected view is to be returned.
	 * 
