 ...
 * 
 * <p>
 * If the base graph is <i>not</i> a ListenableGraph, then the subgraph property
 * cannot be guaranteed. If edges or vertices are removed from the base graph,
 * they are <i>not</i> removed from the subgraph.
 * </p>
 * 
 * <p>
 ...
 * base graph is <i>never</i> affected by any modification made to the subgraph.
 * </p>
 * 
 * <p>
