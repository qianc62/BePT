 ...
 * GraphUnion</tt> uses
 * <tt>WeightCombiner</tt> to choose policy for calculating edge weight.
 * </p>
 */
public class GraphUnion<V, E, G extends Graph<V, E>> extends
		AbstractGraph<V, E> implements Serializable {
	...
	public E getEdge(V sourceVertex, V targetVertex) {
		...
		if ((res == null) && g2.containsVertex(sourceVertex)
