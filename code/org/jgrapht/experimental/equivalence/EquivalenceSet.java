 ...
 * will be one or more. <li>The group can only be created using the factory
 * method createGroupWithElement(). <li>The equals and hashcode of a group uses
 * the EquivalenceComparator on one of the group members, thus it is actually
 * checking whether the "other" is in the same group.
 * 
 * @param <E>
