 ...
 * implementations. It can be used in two ways: <li>You can can let this class
 * to determine what is the most efficient algorithm for your graph. <li>You can
 * specify the type of your graph (planar / tree / other) and save this class
 * the graph-checking time.
 * 
 * <p>
...
public class AdaptiveIsomorphismInspectorFactory {
	 ...
	 *         with a topological comparator. This implementation uses: <li>
