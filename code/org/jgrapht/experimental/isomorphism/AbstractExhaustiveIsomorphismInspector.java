...
abstract class AbstractExhaustiveIsomorphismInspector<V, E> implements
	...
	/**
	 * Inits needed data-structures , among them: <li>LabelsGraph which is a
	 * created in the image of graph1 <li>vertexPermuteIter which is created
	 * after the vertexes were divided to equivalence groups. This saves
	 * order-of-magnitude in performance, because the number of possible
	 * permutations dramatically decreases.
	 * 
	 * <p>
