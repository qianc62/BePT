 ...
 * Contributor(s):   -
 *
 * $Id: ModifiableInteger.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
...
public class ModifiableInteger extends Number implements Comparable {
	 ...
	 *         <code>0</code> if this <code>ModifiableInteger</code> is
	 ...
	 * (as <code>ModifiableInteger</code> objects are only comparable to other
	 * <code>ModifiableInteger</code> objects).
	 * 
	 * @param o
     ...
     * ModifiableInteger</code>; a value less
	 *         than <code>0</code> if the argument is a
	 *         <code>ModifiableInteger</code> numerically greater than this
	 *         <code>ModifiableInteger</code>; and a value greater than <code>
     * 0</code>
	 *         if the argument is a <code>ModifiableInteger</code> numerically
     ...
     * int</code>
	 *         value represented by this <code>ModifiableInteger</code> object.
	 */
	public int hashCode() {
		return this.value;
	}
